...
from ...schemas import LoginRequest, TokenResponse, UserResponse, LogoutResponse
...
MOCK_USERS = {
    "admin": {
        ...
        "role": "admin",
        "password_hash": "$2b$12$RcRwybZp/s4hALMwOh7seOSQCmQUjm.QyG1zNWfhvTVut3FD9pq.C",  # admin123
        "is_active": True,
    },
    "trader": {
        "id": TRADER_USER_ID,
        ...
        "role": "trader",
        "password_hash": "$2b$12$cbaIa8dC/licquXna9TO9uT8oKqPFEcPdckXK5IdFMQWXhJCQLeB.",  # trader123
        "is_active": True,
    },
}
...
@router.post(
    ...
    summary="User Login",
    description="Authenticates a user via LDAP or mock store and returns JWT access and refresh tokens."
)

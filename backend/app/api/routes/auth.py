...
MOCK_USERS = {
    "admin": {
        ...
        "role": "admin",
        "password_hash": "$2b$12$2KVBI18BfpV9LVaT.htmoOSTLHyzOo1/tBS68M6sZxIwiw0qWnuxa",
        "is_active": True,
    },
    "trader": {
        "id": TRADER_USER_ID,
        ...
        "role": "trader",
        "password_hash": "$2b$12$aE.IAKGQJTYVXMXJpIFlLO4zjXTSg.7YyE7RgLtek7Vk/tR77j1aK",
        "is_active": True,
    },
}
...
@router.post(
    ...
    summary="User Login",
    description="Authenticates a user via LDAP or mock credentials and returns JWT access and refresh tokens."
)
